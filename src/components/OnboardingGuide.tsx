...
const ETAPES_SOIGNANT: Etape[] = [
  ...
  { id: 'documents', titre: 'Téléversez vos documents', description: 'Diplômes, pièce d\'identité, attestations. Ces documents sont obligatoires pour postuler aux missions.', icone: FileUp, lien: '/soignant/mes-documents', labelLien: 'Ajouter mes documents' },
  ...
  { id: 'score', titre: 'Score Jolene & DPAE', description: 'Votre score qualité reflète votre fiabilité (notations, ponctualité, ancienneté). Pour signer un CDD, complétez vos infos DPAE (lieu de naissance, NIR, etc.).', icone: Star,
    encart: { titre: 'DPAE incomplète ?', texte: 'Pour pouvoir signer des CDD, remplissez votre identité DPAE complète (NIR, lieu de naissance, nationalité).', lien: '/soignant/dpae', labelLien: 'Compléter ma DPAE' } },

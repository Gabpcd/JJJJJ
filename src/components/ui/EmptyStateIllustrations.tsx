/**
 * Illustrations line-art teal pour `<EmptyState />`.
 * Sprint 8 ter-A BIS — extraites de `<EtatVide />` (legacy).
 *
 * Toutes les illustrations sont en 100×100, color: text-primary,
 * strokeWidth uniforme. Sprint 9 Y2K Gen Z les remplacera par la
 * mascotte Jolene.
 *
 * Usage :
 *   <EmptyState illustration={<IllustrationBoussole />} titre="..." />
 */

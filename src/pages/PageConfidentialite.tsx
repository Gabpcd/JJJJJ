      ...
      <section id="art3">
        ...
        <div className="grid gap-4 sm:grid-cols-2 mb-3">
          ...
          <div className="bg-muted/50 border border-border rounded-xl p-4">
            ...
            <p className="text-muted-foreground">Région principale du projet : eu-west-1 (Irlande, Union européenne)</p>
          </div>
        </div>
        <div className="bg-muted/50 border-l-4 border-primary p-4 rounded-r-xl my-4">
        ...
        <div className="overflow-x-auto mb-3">
          <table className="w-full text-sm border border-border rounded-xl overflow-hidden">
            ...
            <tbody className="divide-y divide-border">
              ...
              <tr><td className="px-4 py-2 text-foreground">Supabase Pte. Ltd.</td><td className="px-4 py-2 text-muted-foreground">Authentification, base de données, fonctions serveur et stockage</td><td className="px-4 py-2 text-muted-foreground">Données du compte et du service</td><td className="px-4 py-2 text-muted-foreground">Projet en région eu-west-1 (Irlande, Union européenne) ; opérations techniques selon les garanties contractuelles applicables</td></tr>

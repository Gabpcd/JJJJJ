...
export default function PageCGU() {
  return (
    <LayoutLegal titre="Conditions Générales d'Utilisation" dateMaj="12 mars 2026" toc={TOC}>
      {/* Article 1 */}
      <section id="art1">
      ...
      {/* Article 3 */}
      <section id="art3">
        <h2 className="text-xl font-bold text-primary mb-4">Article 3 — Inscription et vérification</h2>

        <h3 className="text-base font-semibold text-foreground mt-6 mb-2">3.1 — Inscription</h3>
        ...
        <h3 className="text-base font-semibold text-foreground mt-6 mb-2">3.2 — Vérification des Soignants</h3>
      ...
      {/* Article 4 */}
      <section id="art4">
        <h2 className="text-xl font-bold text-primary mb-4">Article 4 — Fonctionnement de la Plateforme</h2>

        <h3 className="text-base font-semibold text-foreground mt-6 mb-2">4.1 — Publication et acceptation de missions</h3>
        ...
        <h3 className="text-base font-semibold text-foreground mt-6 mb-2">4.2 — Contrat de mission</h3>
        ...
        <h3 className="text-base font-semibold text-foreground mt-6 mb-2">4.3 — Moteur de conformité au droit du travail</h3>
        ...
        <h3 className="text-base font-semibold text-foreground mt-6 mb-2">4.4 — Pointage et géolocalisation</h3>
      ...
      {/* Article 7 */}
      <section id="art7">
        <h2 className="text-xl font-bold text-primary mb-4">Article 7 — Score de fiabilité et parcours 3 200 heures</h2>

        <h3 className="text-base font-semibold text-foreground mt-6 mb-2">7.1 — Score de fiabilité</h3>
        ...
        <h3 className="text-base font-semibold text-foreground mt-6 mb-2">7.2 — Parcours 3 200 heures et passage en libéral</h3>
      ...
      <section id="art8">
        ...
        <p className="mb-3">Tout utilisateur peut résilier son compte à tout moment depuis son espace personnel ou par demande adressée à contact@jolene.app.</p>
      ...
      {/* Article 9 */}
      <section id="art9">
        <h2 className="text-xl font-bold text-primary mb-4">Article 9 — Droit applicable</h2>

...
const faqParProfession: Record<string, { q: string; a: string }[]> = {
  'infirmier-ide': [
    ...
    { q: 'Quels documents faut-il pour s\'inscrire en tant qu\'IDE ?', a: 'Vous aurez besoin de votre Diplôme d\'État Infirmier, de votre numéro RPPS, d\'une attestation d\'assurance RCP en cours de validité et d\'une pièce d\'identité. La vérification prend moins de 24h.' },

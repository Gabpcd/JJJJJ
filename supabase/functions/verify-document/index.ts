    ...
    const systemPrompt = `Tu es un vérificateur de documents professionnels de santé. Analyse le document fourni et réponds UNIQUEMENT en JSON valide avec cette structure exacte:
{
  ...
  "scolarite_formation": "IFSI" ou "IFAS" ou "MEDECINE_DFGSM" ou "MEDECINE_DFASM" ou "PHARMACIE" ou "MAIEUTIQUE" ou "ODONTOLOGIE" ou "KINE" ou "ERGOTHERAPIE" ou "PEDICURE_PODOLOGIE" ou "PSYCHOMOTRICITE" ou "MANIP_RADIO" ou "AUTRE" ou null,
...
Analyse ce document et vérifie sa conformité.`;
    ...
    // Les passerelles étudiantes dépendent de crédits, stages, UE et parfois
    // d'une AFGSU ou d'un certificat ordinal. Une année extraite par IA ne
    // suffit jamais à ouvrir automatiquement l'accès aux missions.
    if (doc.type_document === "ATTESTATION_SCOLARITE" && verdictFinal === "VERIFIE") {
      verdictFinal = "EN_ATTENTE";
      motifRejet = "Attestation lisible — revue humaine obligatoire des crédits, stages, unités d’enseignement et autorisations réglementaires avant toute candidature.";
    }

-- ============================================================
-- URGENT 2 Option B — Historique factures commission
-- ============================================================
-- fn_obligations_financieres retourne désormais :
--   - factures_commission_historique : 10 dernières PAYEE/ANNULEE
--   - nb_factures_commission_historique : compteur total
--
-- UX étab : les factures payées restent visibles pour la compta,
-- pas seulement les impayées. KPI "Commissions Jolene" cliquable
-- et section collapsible "Historique".
-- ============================================================

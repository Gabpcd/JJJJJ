-- ============================================================
-- Bug 1 — fn_obligations_financieres expose paiement CONTESTE
-- ============================================================
-- Sous-requête missions_non_payees expose 2 champs supplémentaires pour
-- permettre au frontend d'afficher un badge "⚠️ Litige en cours" et
-- désactiver les boutons de paiement sur les missions concernées :
--
--   - a_paiement_conteste  (boolean) : TRUE si paiements_soignant
--                                      statut='CONTESTE' existe
--   - paiement_conteste_id (text)    : id du paiement le plus récent
--                                      pour lien "Voir le litige"
-- ============================================================

-- fn_traiter_candidature : (1) RCP exigée uniquement pour une mission LIBÉRALE
-- (un salarié est couvert par la RCP de l'employeur) ; (2) contrat salarié = 'CDD'
-- (décision : CDD, pas CDDU ; le template actif est 'CDD' — 'CDDU' donnait un contrat vide).

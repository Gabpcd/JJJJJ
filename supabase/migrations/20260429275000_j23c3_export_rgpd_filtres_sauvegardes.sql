-- J2.3.C.3 — fn_exporter_mes_donnees v4 : ajoute clé `filtres_sauvegardes` (25 clés total).
-- Applique l'art. 20 RGPD (portabilité) au nouveau module filtres + alertes (J2.3.C).
...
BEGIN
  ...
  PERFORM public.fn_ecrire_audit_safe(
    ...
    p_details := jsonb_build_object('version', 'v4_avec_filtres_sauvegardes')
  );

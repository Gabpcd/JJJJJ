...
WITH reviewed(signature, qualified_signature, categorie, justification) AS (
  VALUES
    ...
    ('fn_protect_candidature_statut()', 'public.fn_protect_candidature_statut()', 'TRIGGER_INTERNE', 'Trigger interne : protège les transitions de candidature et n’autorise une réactivation établissement que dans le contexte atomique de la RPC métier.'),
    ...
    ('fn_traiter_candidature_planning_v1_internal_20260810(uuid,text,jsonb,text)', 'public.fn_traiter_candidature_planning_v1_internal_20260810(uuid,text,jsonb,text)', 'INTERNE_NON_EXPOSEE', 'Implémentation durcie du traitement avec confirmation du planning exact, conservée derrière le garde réglementaire étudiant.'),
    ...
    ('fn_recalculer_preuves_etudiant_internal_20260810(uuid)', 'public.fn_recalculer_preuves_etudiant_internal_20260810(uuid)', 'INTERNE_NON_EXPOSEE', 'Implémentation historique durcie du recalcul des preuves étudiantes, conservée derrière la façade complète.'),
    ('fn_recalculer_preuves_etudiant(uuid)', 'public.fn_recalculer_preuves_etudiant(uuid)', 'INTERNE_SERVICE_ROLE', 'Recalcul documentaire serveur : complète la passerelle pédicurie-podologie uniquement après revue humaine réglementaire.'),
    ('fn_admin_moderer_document_internal_20260810(uuid,text,text,jsonb,text)', 'public.fn_admin_moderer_document_internal_20260810(uuid,text,text,jsonb,text)', 'INTERNE_NON_EXPOSEE', 'Implémentation interne durcie de la modération documentaire, appelée uniquement par la façade contextualisée.'),

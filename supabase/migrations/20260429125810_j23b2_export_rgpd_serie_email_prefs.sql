-- J2.3.B.2 — Étendre fn_exporter_mes_donnees avec serie_email_envois +
-- preferences_notifications (RGPD article 15 droit d'accès complet).
...
BEGIN
  ...
  PERFORM public.fn_ecrire_audit_safe(
    ...
    p_details := jsonb_build_object('version', 'v3_avec_prefs_notifs')
  );

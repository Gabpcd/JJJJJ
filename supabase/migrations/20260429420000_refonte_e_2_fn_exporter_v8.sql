-- Refonte.E.2 — fn_exporter_mes_donnees v8 : 30 clés
-- Ajouts : notations_donnees + notations_recues + scoring_breakdown_historique
...
BEGIN
  ...
  SELECT jsonb_build_object(
    ...
    -- Refonte.E.2 v8 : ajout 3 nouvelles clés notations + scoring
  ...
  PERFORM public.fn_ecrire_audit_safe(
    ...
    p_details := jsonb_build_object('version', 'v8_avec_notations_scoring')
  );

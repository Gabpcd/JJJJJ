-- Ajoute chorus_pro_statut + est_secteur_public aux factures_impayees retournées
-- par fn_obligations_financieres, pour que FacturationEtablissement puisse afficher
-- le statut Chorus Pro des factures secteur public.

-- fn_dashboard_soignant_complet : appliquer la hiérarchie pro au widget
-- "missions ouvertes" pour cohérence avec MissionsSoignant + RechercheMissions.
--
-- Avant : strict match profession_requise = soignant.profession.
-- Conséquence : un IBODE ne voyait pas les missions IDE sur son dashboard
-- alors qu'il les voyait sur /soignant/missions et /soignant/recherche-missions.
-- Après : utilise fn_soignant_compatible_mission (helper livré la veille
-- en migration 20260427150000).

-- Itération 1 : 2 fixes sur fn_calculer_score_fiabilite_v2
-- B.10 — Floating-point seuil 70 : score 69.999... affiché 70.00 mais classé ARGENT.
--        Solution : ROUND(v_score, 2) avant comparaison niveau (et stockage 2 décimales).
-- C    — COUNT direct au lieu de soignants.total_missions_terminees pour en_periode_probatoire.
--        Évite la dépendance au compteur dénormalisé maintenu par dec_mettre_a_jour_fiabilite.
...
BEGIN
  ...
  -- Itération 1 fix C : COUNT direct au lieu de colonne dénormalisée
  ...
  -- Itération 1 fix B.10 : ROUND avant CASE pour éviter epsilon floating-point

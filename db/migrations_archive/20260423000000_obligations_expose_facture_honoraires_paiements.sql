-- A.5 — expose facture_honoraires_id dans paiements_soignants_confirmes et _en_attente
-- pour permettre le téléchargement direct du PDF depuis la page Obligations/Facturation
-- sans avoir à naviguer vers la fiche mission.
